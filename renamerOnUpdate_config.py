...
tag_templates = {
"Performer Sort": "{($studio).}{[$date].}{'$performer'.}$title",
"Tube Compilation": "{($studio).}{[$date].}{'$performer'.}$title",
"Unidentified": "{($studio).}{[$date].}{'$performer'.}$title",
# "Anal" : "{($studio)}.{'$performer'}.$title.{[$date]} [Anal]"
}
...
default_template = "{($studio).}{[$date].}{'$performer'.}$title"
...
"Tube Compilation": r"F:\Stashed\!Compilations",
}
...
# {studio}.{year}.{month}.{day}.{performer1firstname}.{performer1lastname}.{performer2}.{title}
